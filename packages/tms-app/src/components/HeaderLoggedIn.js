...
export default function HeaderLoggedIn() {
  ...
  return (
    <div className="mt-1 mb-3 my-sm-0 ml-sm-auto">
      ...
      {auth.currentUser && (
        <>
          <Link to="/user" data-tooltip-content="Manage My Profile" data-tooltip-id="profile-tooltip" className="text-white mr-2 header-icon">
      ...
      <Link to="/" onClick={onLogout} data-tooltip-content="Logout" data-tooltip-id="login-tooltip" className="text-white header-icon">
